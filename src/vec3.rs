...
impl Vec3
{
    ...
    pub fn refract(a : Vec3, b : Vec3, ni_over_nt : f32) -> Option<Vec3>
    {
        ...
        else { Some((v - b * dt) * ni_over_nt - b * discriminant.sqrt()) }
    }
    ...
    {
        Vec3::new(self.x, self.y * a.cos() - self.z * a.sin(), self.y * a.sin() + self.z * a.cos())
    }

    pub fn rotate_y(&self, a : f32) -> Vec3
    {
        Vec3::new(self.x * a.cos() + self.z * a.sin(), self.y, -self.x * a.sin() + self.z * a.cos())
    }
